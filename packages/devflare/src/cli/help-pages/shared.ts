...
export const PREVIEWS_COMMON_OPTIONS: HelpEntry[] = [
	{
		command: '--account <id>',
		description:
			'Use a specific Cloudflare account for preview Worker and preview-resource operations'
	}
]
...
function createOptionedSubcommandHelpPageFactory(
	parentPath: string
): OptionedSubcommandHelpPageFactory {
...
export const createProductionsSubcommandPage =
	createOptionedSubcommandHelpPageFactory('productions')
